...
The Visa shopping microservice provides core shopping experience for mobile apps and web applications.
This microservice provides endpoints to create, update, delete resources, and supports OData compliant endpoints for high flexibility of querying the data.
